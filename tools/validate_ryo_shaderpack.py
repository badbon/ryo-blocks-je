...
def main() -> None:
    ...
    with zipfile.ZipFile(args.shaderpack) as archive:
        ...
        for required in ("texture(gtexture, atlasCoord)", "texture(ryoTexture, ryoCoord)", "RYO_OVERLAY_STRENGTH", "ryo.a"):
        ...
        with archive.open("shaders/textures/ryo.png") as raw:
            ...
            generated.load()
        expected_tile = shader_overlay_source(args.source_image, args.target_size)
